                ...
                <div className="space-y-4">
                    {matches.length > 0 ? (
                        matches.map((match) => (
                            <div
                                key={match._id}
                                className="bg-white/80 backdrop-blur-md border border-white p-4 rounded-3xl shadow-sm hover:shadow-md transition-all flex items-center justify-between group"
                            >
                        ...
                        <div className="text-center py-20 bg-white/50 rounded-[3rem] border-2 border-dashed border-teal-200">
                            ...
                            <p className="text-gray-500">
                                Keep exploring and liking profiles!
                            </p>
